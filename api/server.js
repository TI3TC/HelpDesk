...
const TENANT_ID = process.env.MS_TENANT_ID || 'a2f44e6b-598b-4d56-8e01-c63c72e21c10'; // ajuste se mudar
const CLIENT_ID = process.env.MS_CLIENT_ID || 'd6881117-d053-4933-a5e2-b13532f2af95'; // ajuste se mudar

const app = express();
app.use(express.json());
app.use(cookieParser());

// sessão em memória (simples). Em produção, use Redis/DB.
